...
export default function AuthForm() {
    ...
    const FieldsForAuthForm = useMemo(() => {
        ...
        <div className="height-[80%]">
            ...
            <div className="flex flex-col mt-4 gap-1">
                ...
                <Input key="email" errors={errors["email"] as FieldError} disabled={isLoading} label="email" register={register} required={true} placeholder="Enter your email" />
            </div>
            ...
            <div className="flex flex-col mt-4 gap-1">
                ...
                <Input key="password" errors={errors["password"] as FieldError} disabled={isLoading} label="password" register={register} required={true} placeholder="Enter your password" />
            </div>
    ...
    const RegisterOrLogin = () => {
        ...
        const headsUp = variant === 'LOGIN' ? 
        <div className="text-sm text-gray-500">
            Or you are new here?
            <button className="underline ml-1" type="button" onClick={toggleVariant}> Register</button> now!
        </div> :
            <div className="text-sm text-gray-500">
                Or you already have an account?
            <button className="underline ml-1" type="button" onClick={toggleVariant}> Login</button> now!
        </div> 

        return(<div className="flex flex-col mt-8 gap-3">
            {button}
